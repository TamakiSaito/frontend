...
export default function WidthHeightPaddingMargin() {
  return (
    <div>
      ...
      <div className="m-7 bg-red-300">m-7</div>
      <div className="m-8 bg-blue-300">m-8</div>
      <div className="m-9 bg-yellow-300">m-9</div>
      <div className="m-10 bg-red-300">m-10</div>
      <div className="m-11 bg-blue-300">m-11</div>
      <div className="m-12 bg-yellow-300">m-12</div>
      <div className="p-[100px] bg-gray-700">p-[100px]</div>
      <div className="m-[100px] bg-red-700">m-[100px]</div>

      <div className="text-red-500 font-bold">*p,mは、pt, pb, pl, pr, px, pyで調節可能</div>
