  ...
  return (
    <div>
      ...
      <div className="flex items-center">
        ...
        <div className="text-center h-[90px] p-2 bg-yellow-300">items-center</div>
      </div>
      ...
      <div className="flex items-start">
        ...
        <div className="text-center h-[90px] p-2 bg-yellow-300">items-start</div>
      </div>
      ...
      <div className="flex justify-between mt-5">
        ...
        <div className="w-[70px] p-2 bg-blue-300">justify-between</div>
        <div className="w-[90px] p-2 bg-yellow-300">justify-between</div>
      </div>

      <div className="flex justify-center mt-5">
        <div className="w-[50px] p-2 bg-red-300">justify-center</div>
        <div className="w-[70px] p-2 bg-blue-300">justify-center</div>
        <div className="w-[90px] p-2 bg-yellow-300">justify-center</div>
      </div>

      <div className="flex justify-start mt-5">
        <div className="w-[50px] p-2 bg-red-300">justify-start</div>
        <div className="w-[70px] p-2 bg-blue-300">justify-start</div>
        <div className="w-[90px] p-2 bg-yellow-300">justify-start</div>
      </div>

      <div className="flex justify-end mt-5">
        <div className="w-[50px] p-2 bg-red-300">justify-end</div>
        <div className="w-[70px] p-2 bg-blue-300">justify-end</div>
        <div className="w-[90px] p-2 bg-yellow-300">justify-end</div>
      </div>
